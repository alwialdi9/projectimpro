                ...
                <div class="col-4">
                    <form class="mt-5" method="POST" action="{{ url('/signin') }}">
                      ...
                      <div class="mt-3 sosmed">
                        <a href="{{ url('auth/google') }}" class="mx-3 img-sosmed"><img src="img/AssetLogin/google-logo-png-suite-everything-you-need-know-about-google-newest-0.png" alt="" width="30" height="30" class="btn-google"></a>

                        <a href="{{ url('auth/facebook') }}" class="mx-3 img-sosmed"><img src="img/AssetLogin/d2e5359f8402cb8d3d7b22c463f9013b.png" alt="" width="30" height="30" class="btn-fb"></a>
                      </div>
